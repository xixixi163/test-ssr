import { unref, inject, hasInjectionContext, getCurrentInstance, version, defineAsyncComponent, defineComponent, h, computed, ref, provide, shallowReactive, watch, Suspense, Fragment, createApp, toRef, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, mergeProps, getCurrentScope, withCtx, nextTick, useSSRContext } from 'file:///Users/yiqian/Desktop/my-study/nuxt/test-ssr/node_modules/vue/index.mjs';
import { $fetch } from 'file:///Users/yiqian/Desktop/my-study/nuxt/test-ssr/node_modules/ofetch/dist/node.mjs';
import { b as baseURL } from '../_/renderer.mjs';
import { createHooks } from 'file:///Users/yiqian/Desktop/my-study/nuxt/test-ssr/node_modules/hookable/dist/index.mjs';
import { getContext } from 'file:///Users/yiqian/Desktop/my-study/nuxt/test-ssr/node_modules/unctx/dist/index.mjs';
import { sanitizeStatusCode, createError as createError$1, appendHeader } from 'file:///Users/yiqian/Desktop/my-study/nuxt/test-ssr/node_modules/h3/dist/index.mjs';
import { getActiveHead, CapoPlugin } from 'file:///Users/yiqian/Desktop/my-study/nuxt/test-ssr/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/yiqian/Desktop/my-study/nuxt/test-ssr/node_modules/@unhead/shared/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///Users/yiqian/Desktop/my-study/nuxt/test-ssr/node_modules/vue-router/dist/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file:///Users/yiqian/Desktop/my-study/nuxt/test-ssr/node_modules/radix3/dist/index.mjs';
import { defu } from 'file:///Users/yiqian/Desktop/my-study/nuxt/test-ssr/node_modules/defu/dist/defu.mjs';
import { hasProtocol, isScriptProtocol, joinURL, withQuery } from 'file:///Users/yiqian/Desktop/my-study/nuxt/test-ssr/node_modules/ufo/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderAttrs } from 'file:///Users/yiqian/Desktop/my-study/nuxt/test-ssr/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-dsn7uxPU.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-CezlTm-z.mjs').then((m) => m.default || m))
};
